...
| 主日 | `sunday` | `month` | 月內第 1/2 次，`YYYY-MM#N` | `2026-07#1` |
...
- 小家/主日月內兩次：使用 `YYYY-MM#1`、`YYYY-MM#2`，整月可完成，但第 2 次需在第 1 次完成後才可打卡。
...
| 主日 | 月任務，每月固定顯示第 1 次與第 2 次。 | 每月可完成兩次，第 1 次完成後才可完成第 2 次。 |
